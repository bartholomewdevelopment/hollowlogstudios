...
const CommissionMessageDialog: React.FC<CommissionMessageDialogProps> = ({
  open,
  onOpenChange,
  commissionId,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] flex flex-col">
        <DialogHeader>
          <DialogTitle>Messages for {commissionTitle}</DialogTitle>
        </DialogHeader>
...
export default CommissionMessageDialog;
